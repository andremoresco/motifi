import User, { MongoUserInterface } from "../repository/implementations/mongoModels/MongoUserModel";


export default class UserService {

    public async findById(id: number): Promise<MongoUserInterface | null> {
        return await User.findById(id);
    }

    public async list(): Promise<MongoUserInterface[]> {
